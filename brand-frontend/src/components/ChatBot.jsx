...
export default function ChatBot() {
  ...
  const handleAction = (action, data) => {
    if (action === "whatsapp") {
      ...
      window.open(`https://wa.me/919660994037?text=${encodeURIComponent(message)}`, "_blank");
  ...
  const handleSuggestion = (suggestion) => {
    if (suggestion === "Browse Products" || suggestion === "Browse All Products") {
      ...
      window.open(`https://wa.me/919660994037?text=${encodeURIComponent("Hello! I need assistance.")}`, "_blank");
  ...
  const quickActions = [
    ...
    { label: "Contact Us", action: () => window.open(`https://wa.me/919660994037?text=${encodeURIComponent("Hello! I need assistance.")}`, "_blank") },
  ];
